...
from one_rag.ragas_evaluation import FastEmbedRagasEmbeddings, aggregate, is_abstention, map_metric_scores, select_winner, validate_dataset, validate_manifest


def manifest():
    return {
        "dataset_version": "1.0.0",
        "judge": {"model": "gemini-2.5-flash-lite", "temperature": 0},
